...
LOGGER = logging.getLogger("pnet_data")
LOGGER.setLevel(logging.DEBUG)
LOGGER.addHandler(console_handler)

WIDER_DIR = "/opt/data/wider"
ANNOTATION_FILE = os.path.join(WIDER_DIR, "wider_face_train.txt")
...
if __name__ == "__main__":
    ...
    for annotation in annotations:
        ...
        # load image
        img = cv2.imread(os.path.join(IMAGE_DIR, im_path + '.jpg'))
        idx += 1
        # if idx % 100 == 0:
